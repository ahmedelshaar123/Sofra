...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <a href="{{url(route('payment-method.create'))}}" class="btn btn-primary"><i class="fa fa-plus"></i> New payment method</a>
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url(route('payment-method.edit', $record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit"> Edit</i></a>
