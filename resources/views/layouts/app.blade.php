        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="{{url(route('city.index'))}}"><i class="fa fa-flag-o"></i> <span>Cities</span></a></li>
                <li><a href="{{url(route('category.index'))}}"><i class="fa fa-list"></i> <span>Categories</span></a></li>
                <li><a href="{{url(route('payment-method.index'))}}"><i class="fa fa-money"></i> <span>Payment Methods</span></a></li>
                <li><a href="{{url(route('contact.index'))}}"><i class="fa fa-phone"></i> <span>Contacts</span></a></li>
                <li><a href="{{url(route('review.index'))}}"><i class="fa fa-book"></i> <span>Reviews</span></a></li>
                <li><a href="{{url(route('offer.index'))}}"><i class="fa fa-gift"></i> <span>Offers</span></a></li>
                <li><a href="{{url(route('client.index'))}}"><i class="fa fa-user"></i> <span>Clients</span></a></li>
                <li><a href="{{url(route('product.index'))}}"><i class="fa fa-product-hunt"></i> <span>Products</span></a></li>
                <li><a href="{{url(route('order.index'))}}"><i class="fa fa-tasks"></i> <span>Orders</span></a></li>
                <li><a href="{{url(route('restaurant.index'))}}"><i class="fa fa-cutlery"></i> <span>Restaurants</span></a></li>
